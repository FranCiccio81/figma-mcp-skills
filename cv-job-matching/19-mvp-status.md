...
| **I — Indice de confiance** | ✅ | Calculé par le moteur, distinct du score, `unknown_dimensions` exposées | Calibration sur jeu annoté non faite (§7) |
